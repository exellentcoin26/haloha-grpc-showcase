...
import { login, LoginError } from "@/lib/authentication";
...
function handleLoginError(error: LoginError): FieldErrors {
    if (error.kind === "form") {
        ...
        // grpc login call error
        return {
            username: "username/password combination incorrect",
        };
    }
}
...
export default function Home() {
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        if (result.ok) {
            ...
            setFieldErrors(handleLoginError(result.val));
        }
    };
